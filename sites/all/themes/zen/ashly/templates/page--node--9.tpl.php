...
<div id="content">
  	...
  	<div id='slideContainer'>
		     ...
		     <p class='defaultImage'>Red Truck</p>
			 <p class='defaultImage2'>Red Truck</p>
			  <div id="slideshow">
			...
			<img src="http://setdesign-la.com/redtruck-images/truck-s.png" alt="Slideshow Image 4" /> 
		</div>	<!-- end slideshow -->
		
	                     <p class='moveContentLayout moveContent'> <b> Content One </b> Bagelmania loves to give to the community. 
						 Click below to find out how.</p>
						 <p class='moveTitleLayout moveTitle'>Title 1</p>
						 
	 
	                     <p class='moveContentLayout moveContent2'> <b> Content Two </b> Bagelmania loves to give to the community. 
						 Click below to find out how.
						 </p>
						 <p class='moveTitleLayout moveTitle2'>Title 2</p>
						 
	          
	                     <p class='moveContentLayout moveContent3'> <b> Content Three </b> Bagelmania loves to give to the community. 
						 Click below to find out how.
						 </p>
						 <p class='moveTitleLayout moveTitle3'>Title 3</p>
						 
	           
	                     <p class='moveContentLayout moveContent4'> <b> Content Four </b> Bagelmania loves to give to the community. 
						 Click below to find out how.
						 </p>
						 <p class='moveTitleLayout moveTitle4'>Title 4</p>
